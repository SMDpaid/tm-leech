...
class TelegraphHelper:
	...
	def create_account(self):
		...
		LOGGER(__name__).info(f"Creating TELEGRAPH Account using  '{self.short_name}' name")
	...
	def create_page(self, title, content):
		try:
			...
			LOGGER(__name__).warning(f'Telegraph Flood control exceeded. I will sleep for {st.retry_after} seconds.')
...
telegraph=TelegraphHelper('KaipullaBots', 'https://t.me/KaipullaBots')
